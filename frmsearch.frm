...
Private Sub showtabel()
    ...
    Or namatabel = "Currency" _
    Or namatabel = "Nota Permintaan" _
    Or namatabel = "Formulir ITG" _
    Or namatabel = "Satuan." _
    Or namatabel = "Master Account" Then OBJ.Open dsn
...
Private Sub grid_Click()
    ...
    Dim clickedHeader As String
    
    originalHeader = grid.TextMatrix(0, m_SortColumn)
    
    Label3 = grid.MouseCol
    If grid.MouseRow > 0 Then
        If namatabel = "Nota Permintaan" Then
            hasil = grid.TextMatrix(grid.Row, 0)
        ElseIf namatabel = "Formulir ITG" Then
            hasil = grid.TextMatrix(grid.Row, 0)
            hasil1 = grid.TextMatrix(grid.Row, 1)
        ...
        Else
            hasil = grid.TextMatrix(grid.Row, 0)
        End If
        'If namatabel = "Formulir ITG" Then
            'hasil = grid.TextMatrix(grid.Row, 2)
        'End If
        Unload Me
        Exit Sub
    End If
    ...
    'clickedHeader = grid.TextMatrix(0, m_SortColumn)
    'If txtcari.Visible = True Then txtcari.SetFocus
    
    'If originalHeader <> clickedHeader Then
        ' Restore original header if it's different
        'grid.TextMatrix(0, m_SortColumn) = originalHeader
    'End If
