...
Private Sub grid_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        ElseIf namatabel = "Voucher" Then
            hasil1 = grid.TextMatrix(grid.Row, 0)
        ElseIf namatabel = "Allvoucher" Then
            hasil1 = grid.TextMatrix(grid.Row, 0)
...
Private Sub showtabel()
    ...
    If RST.EOF Then
        ...
        ElseIf namatabel = "Voucher" Then
            ...
            grid.ColWidth(2) = 950
            grid.ColWidth(3) = 2700
        ElseIf namatabel = "Allvoucher" Then
            grid.ColWidth(0) = 700
            grid.ColWidth(1) = 950
            grid.ColWidth(2) = 2700
            grid.ColWidth(3) = 1500
        ElseIf namatabel = "Voucher Penerimaan" Then
            grid.ColWidth(0) = 900
            grid.ColWidth(1) = 1500
            grid.ColWidth(2) = 1700
            grid.ColWidth(3) = 2700
        ElseIf namatabel = "Unposting Pembayaran Hutang" Then
            grid.ColWidth(0) = 900
            grid.ColWidth(1) = 1500
            grid.ColWidth(2) = 2700
        Else
...
Private Sub Form_Load()
    ...
    ElseIf namatabel = "Voucher Penerimaan" Then
        Me.Width = 8000
        grid.Width = 7370
        cmdcancel.Width = 7370
    ElseIf namatabel = "Unposting Pembayaran Hutang" Then
        Me.Width = 6000
        grid.Width = 5700
        cmdcancel.Width = 5700
    End If
    showtabel
End Sub
...
Private Sub txtsearch_Change()
    ...
    ElseIf namatabel = "Allvoucher" Then
        SQL = "Select a.novoucher,a.tgl,a.kepada,SUM(b.jumlah)as Jumlah From am_voucherhdr a "
        SQL = SQL + "inner join am_voucherin b on a.novoucher = b.novoucher"
        SQL = SQL + " Where a." + Label4 + " like '" + txtsearch + "%'"
        SQL = SQL + " group by a.novoucher,a.tgl,a.kepada order by a.novoucher"
    ElseIf namatabel = "Voucher Penerimaan" Then
        If Label4 = "NoBPB" Then Label4 = "NoBeli"
        If Label4 = "Voucher" Then Label4 = "ref1"
        If Label4 = "NoApply" Then Label4 = "ref2"
        SQL = carisql1 + " and " + Label4 + " like '" + txtsearch + "%' order by Ref1 desc"
    ElseIf namatabel = "Unposting Pembayaran Hutang" Then
        If Label4 = "NoApply" Then Label4 = "c.NoApply"
        SQL = carisql1 + " and " + Label4 + " like '" + txtsearch + "%' order by a.nobkt desc"
