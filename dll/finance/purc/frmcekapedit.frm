...
Begin VB.Form frmcekapedit 
   ...
   Begin TDBText6Ctl.TDBText txtbukti 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmcekapedit.frx":2B4A
      Key             =   "frmcekapedit.frx":2B68
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilai 
      ...
      _ExtentX        =   1931
      _ExtentY        =   450
      Calculator      =   "frmcekapedit.frx":2BA4
      Caption         =   "frmcekapedit.frx":2BC4
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmcekapedit.frx":2C30
      Keys            =   "frmcekapedit.frx":2C4E
      Spin            =   "frmcekapedit.frx":2C90
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBText6Ctl.TDBText txtket 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmcekapedit.frx":3CA6
      Key             =   "frmcekapedit.frx":3CC4
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilai1 
      ...
      _ExtentX        =   2778
      _ExtentY        =   450
      Calculator      =   "frmcekapedit.frx":3D00
      Caption         =   "frmcekapedit.frx":3D20
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmcekapedit.frx":3D8C
      Keys            =   "frmcekapedit.frx":3DAA
      Spin            =   "frmcekapedit.frx":3DEC
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtsisa 
      ...
      _ExtentX        =   2990
      _ExtentY        =   450
      Calculator      =   "frmcekapedit.frx":3E14
      Caption         =   "frmcekapedit.frx":3E34
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmcekapedit.frx":3EA0
      Keys            =   "frmcekapedit.frx":3EBE
      Spin            =   "frmcekapedit.frx":3F00
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilaikurs 
      ...
      _ExtentX        =   2778
      _ExtentY        =   503
      Calculator      =   "frmcekapedit.frx":3F28
      Caption         =   "frmcekapedit.frx":3F48
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmcekapedit.frx":3FB4
      Keys            =   "frmcekapedit.frx":3FD2
      Spin            =   "frmcekapedit.frx":4014
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "frmcekapedit"
...
Private Sub cmdadd_Click()
    ...
    OBJ.Open dsn
    SQL = "select * from am_apcashsub Where nobukti = '" & txtbukti & "'"
    Set RST = OBJ.Execute(SQL)
    Do While Not RST.EOF
        If RST!Type = "G" Then
            OBJ1.Open dsn
            SQL1 = "select * from am_apcashlin Where kodebayar = 'GT' and noapply = '" & RST!nogiro & "'"
            Set RST = OBJ.Execute(SQL)
            If Not RST.EOF Then
                MsgBox "User can not change, there is already apply.", vbExclamation, "Warning"
                OBJ.Close
                OBJ1.Close
                Exit Sub
            End If
    ...
    SQL = "select * from am_apcashhdr where nobkt = '" & txtbukti & "' and kodebayar = 'GT'"
    Set RST = OBJ.Execute(SQL)
    If Not RST.EOF Then
        date2 = RST!dateentry
        str2 = RST!identry
    ...
    SQL = "delete from am_apcashhdr where nobkt = '" & txtbukti & "' and kodebayar = 'GT'"
    Set RST = OBJ.Execute(SQL)
    
    SQL = "delete from am_apcashlin where nobkt = '" & txtbukti & "' and kodebayar = 'GT'"
    Set RST = OBJ.Execute(SQL)
...
Private Sub cmdsearch_Click()
    If v_fastsearching = True Then
        If v_fstgl1 > v_fstgl2 Then
            ...
            Exit Sub
        End If
        carisql1 = "select nobkt, convert(char(11),tglbkt )'tglbukti' from AM_apcashhdr where kodebayar = 'GT' and tglbkt >= '" & batas1 & "' and tglbkt <= '" & batas2 & "'"
    Else
        carisql1 = "select nobkt, convert(char(11),tglbkt )'tglbukti' from AM_apcashhdr where kodebayar = 'GT'"
    End If
...
Private Sub Cariar()
    ...
    If Not RST.EOF Then
        ...
        Set RST = OBJ.Execute(SQL)
        If Not RST.EOF Then lblsup = RST!namasupp Else lblsup = ""
        ...
        grid2.Row = 1
        SQL1 = "SELECT * from AM_apCashLin WHERE NoBkt = '" & txtbukti & "' and kodebayar = 'GT'"
        ...
        Do Until RST.EOF
            ...
            SQL1 = "select a.Nogiro, (a.jumlah-(select isnull(sum(b.jumlah),0) from am_apcashlin b where b.nobkt <> '" & txtbukti & "' and b.kodebayar = 'GT' and b.noapply=a.nogiro))'sisagiro'"
            SQL1 = SQL1 + " from AM_apcashsub a left join am_apcashhdr c on a.nobukti=c.nobkt"
            SQL1 = SQL1 + " Where Year(a.tanggalcair) = 1900 And Year(a.tanggaltolak) <> 1900"
            SQL1 = SQL1 + " and c.kodecur='" & txtkurs & "' and a.kodesupp = '" & txtsup & "' and a.nogiro = '" & RST!nogiro & "'"
            Set RST1 = OBJ.Execute(SQL1)
...
jump3:
        ...
        OBJ1.Open dsn
        SQL1 = "SELECT * from AM_apCashsub WHERE NoBkt = '" & txtbukti & "'"
        Set RST1 = OBJ1.Execute(SQL1)
        Do While Not RST1.EOF
