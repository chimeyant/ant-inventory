...
Begin VB.Form frmdaftarbayarbydatedetail 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Listing Pembayaran Detail"
   ClientHeight    =   1650
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3255
   ...
   Begin Chameleon.chameleonButton cmdclose 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmdaftarbayarbydatedetail.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdview 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmdaftarbayarbydatedetail.frx":031A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmdaftarbayarbydatedetail"
...
Private Sub cmdview_Click()
    ...
    Crystal.ReportFileName = AppPath & "\reports\finance\sale\payment_detail2.rpt"
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    ElseIf KeyCode = 114 Then
        ...
        Crystal.WindowShowRefreshBtn = True
        Crystal.Connect = dsnreport
        Crystal.ReportFileName = AppPath & "\reports\finance\sale\payment_detail.rpt"
