...
Public Event GetUserName(ByVal username As String)

Private RS As ADODB.Recordset

Private Sub OpenMSQLDB()
    OpenDB
End Sub
...
Private Sub DoLoadUser()
    On Error GoTo err_handler
    Dim SQL As String
    
    If txtUsername.text = "" Then
        SQL = "select username,realname from am_apuser"
    Else
        SQL = "select username,realname from am_apuser where username like '" + txtUsername + "%'"
    End If
...
Private Sub Timer1_Timer()
    ...
    RaiseEvent GetUserName(DBGrid.Columns(0).Value)
End Sub
