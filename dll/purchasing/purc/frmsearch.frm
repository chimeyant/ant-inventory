...
Private Sub showtabel()
    ...
    ElseIf namatabel = "Permintaan" Then
        SQL = carisql1 + " Where flag='0' and flagpo='1' order by nobkt desc"
    ElseIf namatabel = "Nota Permintaan" Then
        SQL = carisql1 + " Where flag='0'"
    Else
        SQL = carisql1
    End If
    Set RST = OBJ.Execute(SQL)
...
Private Sub txtsearch_Change()
    ...
    ElseIf namatabel = "Permintaan" Then
        SQL = carisql1 + " where flag = '0' and flagpo='1' and " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "Nota Permintaan" Then
        SQL = carisql1 + " Where flag = '0' and " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "Satuan." Then
        SQL = carisql1 + " Where " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "Supplier" Then
        SQL = carisql1 + " where " + Label4 + " like '" + txtsearch + "%'"
    Else
        SQL = carisql1 + " where " + Label4 + " like '" + txtsearch + "%'"
    End If
