...
Begin VB.Form frmpurchaseorderclose 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Close/Cancel Purchase Order"
   ClientHeight    =   6135
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6735
   ...
   EndProperty
   Icon            =   "frmpurchaseorderclose.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TDBText6Ctl.TDBText txtket2 
         ...
         _ExtentX        =   3201
         _ExtentY        =   450
         Caption         =   "frmpurchaseorderclose.frx":2372
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmpurchaseorderclose.frx":23DE
         Key             =   "frmpurchaseorderclose.frx":23FC
      ...
      Begin Chameleon.chameleonButton cmdexit2 
         ...
         MCOL            =   12632256
         MPTR            =   99
         MICON           =   "frmpurchaseorderclose.frx":2438
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Chameleon.chameleonButton cmdsave2 
         ...
         MCOL            =   12632256
         MPTR            =   99
         MICON           =   "frmpurchaseorderclose.frx":2752
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Chameleon.chameleonButton cmdrefresh2 
         ...
         MCOL            =   12632256
         MPTR            =   99
         MICON           =   "frmpurchaseorderclose.frx":2A6C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TDBText6Ctl.TDBText txtket 
         ...
         _ExtentX        =   3201
         _ExtentY        =   450
         Caption         =   "frmpurchaseorderclose.frx":2D86
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmpurchaseorderclose.frx":2DF2
         Key             =   "frmpurchaseorderclose.frx":2E10
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin Chameleon.chameleonButton cmdexit 
         ...
         MCOL            =   12632256
         MPTR            =   99
         MICON           =   "frmpurchaseorderclose.frx":2E4C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Chameleon.chameleonButton cmdsavedesc 
         ...
         MCOL            =   12632256
         MPTR            =   99
         MICON           =   "frmpurchaseorderclose.frx":3166
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Chameleon.chameleonButton cmdrefresh 
         ...
         MCOL            =   12632256
         MPTR            =   99
         MICON           =   "frmpurchaseorderclose.frx":3480
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.ListBox List2 
      Height          =   1815
      ItemData        =   "frmpurchaseorderclose.frx":379A
      Left            =   3720
      List            =   "frmpurchaseorderclose.frx":379C
      Sorted          =   -1  'True
      TabIndex        =   6
      Top             =   1320
      Width           =   2895
   ...
   Begin VB.ListBox List1 
      Height          =   4110
      ItemData        =   "frmpurchaseorderclose.frx":379E
      Left            =   120
      List            =   "frmpurchaseorderclose.frx":37A0
      Sorted          =   -1  'True
      Style           =   1  'Checkbox
      TabIndex        =   3
      Top             =   1320
   ...
   Begin Chameleon.chameleonButton cmdclose 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmpurchaseorderclose.frx":37A2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdpost 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmpurchaseorderclose.frx":3ABC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdclosedesc 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmpurchaseorderclose.frx":3DD6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdpost1 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmpurchaseorderclose.frx":40F0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.ListBox List3 
      Height          =   1815
      ItemData        =   "frmpurchaseorderclose.frx":440A
      Left            =   3720
      List            =   "frmpurchaseorderclose.frx":440C
      Sorted          =   -1  'True
      TabIndex        =   8
      Top             =   3600
      Width           =   2895
   ...
   Begin Chameleon.chameleonButton chameleonButton1 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmpurchaseorderclose.frx":440E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil1 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmpurchaseorderclose.frx":4728
      Caption         =   "frmpurchaseorderclose.frx":4748
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmpurchaseorderclose.frx":47B4
      Keys            =   "frmpurchaseorderclose.frx":47D2
      Spin            =   "frmpurchaseorderclose.frx":4814
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil2 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmpurchaseorderclose.frx":483C
      Caption         =   "frmpurchaseorderclose.frx":485C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmpurchaseorderclose.frx":48C8
      Keys            =   "frmpurchaseorderclose.frx":48E6
      Spin            =   "frmpurchaseorderclose.frx":4928
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "frmpurchaseorderclose"
