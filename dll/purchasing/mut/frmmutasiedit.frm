...
Begin VB.Form frmmutasiedit 
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilai 
      ...
      _ExtentX        =   3201
      _ExtentY        =   450
      Calculator      =   "frmmutasiedit.frx":2372
      Caption         =   "frmmutasiedit.frx":2392
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":23FE
      Keys            =   "frmmutasiedit.frx":241C
      Spin            =   "frmmutasiedit.frx":245E
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
   ...
   Begin VB.PictureBox uncheck 
      ...
      Height          =   255
      Left            =   3600
      Picture         =   "frmmutasiedit.frx":2486
      ScaleHeight     =   255
      ScaleWidth      =   255
      TabIndex        =   11
      Top             =   480
   ...
   Begin VB.PictureBox check 
      ...
      Height          =   255
      Left            =   3840
      Picture         =   "frmmutasiedit.frx":27D4
      ScaleHeight     =   255
      ScaleWidth      =   255
      TabIndex        =   10
      Top             =   480
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil1 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3404
      Caption         =   "frmmutasiedit.frx":3424
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":3490
      Keys            =   "frmmutasiedit.frx":34AE
      Spin            =   "frmmutasiedit.frx":34F0
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil2 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3518
      Caption         =   "frmmutasiedit.frx":3538
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":35A4
      Keys            =   "frmmutasiedit.frx":35C2
      Spin            =   "frmmutasiedit.frx":3604
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil3 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":362C
      Caption         =   "frmmutasiedit.frx":364C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":36B8
      Keys            =   "frmmutasiedit.frx":36D6
      Spin            =   "frmmutasiedit.frx":3718
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil4 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3740
      Caption         =   "frmmutasiedit.frx":3760
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":37CC
      Keys            =   "frmmutasiedit.frx":37EA
      Spin            =   "frmmutasiedit.frx":382C
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil5 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3854
      Caption         =   "frmmutasiedit.frx":3874
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":38E0
      Keys            =   "frmmutasiedit.frx":38FE
      Spin            =   "frmmutasiedit.frx":3940
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil6 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3968
      Caption         =   "frmmutasiedit.frx":3988
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":39F4
      Keys            =   "frmmutasiedit.frx":3A12
      Spin            =   "frmmutasiedit.frx":3A54
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil7 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3A7C
      Caption         =   "frmmutasiedit.frx":3A9C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":3B08
      Keys            =   "frmmutasiedit.frx":3B26
      Spin            =   "frmmutasiedit.frx":3B68
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnil8 
      ...
      _ExtentX        =   1508
      _ExtentY        =   397
      Calculator      =   "frmmutasiedit.frx":3B90
      Caption         =   "frmmutasiedit.frx":3BB0
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmmutasiedit.frx":3C1C
      Keys            =   "frmmutasiedit.frx":3C3A
      Spin            =   "frmmutasiedit.frx":3C7C
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "frmmutasiedit"
...
Private Sub cmdadd_Click()
    ...
    Do While True
        ...
        If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut < '" & tanggalpo & "' and b.type = '01'"
        If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut < '" & tanggalpo & "' and b.type = '01'"
        Set RST1 = OBJ1.Execute(SQL1)
        If Not RST1.EOF Then
            txtnil7 = RST1!qty
        Else
        ...
        If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut < '" & tanggalpo & "' and (b.type = '02' Or b.type = '03')"
        If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut < '" & tanggalpo & "' and (b.type = '02' Or b.type = '03')"
        Set RST1 = OBJ1.Execute(SQL1)
        If Not RST1.EOF Then
            txtnil8 = RST1!qty
        Else
        ...
        If cmbtype = "01" Then txtnil4 = txtnil6 + txtnil2 - txtnil1 + txtnil3 - txtnil5 + txtnil7 - txtnil8 + Val(Format(grid.TextMatrix(grid.Row, 3), "general number"))
        If (cmbtype = "02" Or cmbtype = "03") Then txtnil4 = txtnil6 + txtnil2 - txtnil1 + txtnil3 - txtnil5 + txtnil7 - txtnil8 - Val(Format(grid.TextMatrix(grid.Row, 3), "general number"))
        date2 = date1
        date3 = date1
        ...
        Do While True
            ...
            If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut = '" & tanggal2 & "' and b.type = '01'"
            If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut = '" & tanggal2 & "' and b.type = '01'"
            Set RST1 = OBJ1.Execute(SQL1)
            If Not RST1.EOF Then
                txtnil7 = RST1!qty
            Else
            ...
            If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut = '" & tanggal2 & "' and (b.type = '02' Or b.type = '03')"
            If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & grid.TextMatrix(grid.Row, 1) & "' and b.tglmut = '" & tanggal2 & "' and (b.type = '02' Or b.type = '03')"
            Set RST1 = OBJ1.Execute(SQL1)
            If Not RST1.EOF Then
                txtnil8 = RST1!qty
            Else
    ...
    OBJ.Open dsn
    SQL = "select count(nomut)'totalputar' from am_mutlin where nomut = '" & txtnobukti & "' and type = '" & cmbtype & "'"
    Set RST = OBJ.Execute(SQL)
    pro1.Value = 0
    ...
    OBJ.Open dsn
    SQL = "select * from am_mutlin where nomut = '" & txtnobukti & "' and type = '" & cmbtype & "' order by lineitem"
    Set RST = OBJ.Execute(SQL)
    Do While Not RST.EOF
        ...
        If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & RST!kodebarang & "' and b.tglmut < '" & tanggalpo & "' and b.type = '01'"
        If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & RST!kodebarang & "' and b.tglmut < '" & tanggalpo & "' and b.type = '01'"
        Set RST1 = OBJ1.Execute(SQL1)
        If Not RST1.EOF Then
            txtnil7 = RST1!qty
        Else
        ...
        If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & RST!kodebarang & "' and b.tglmut < '" & tanggalpo & "' and (b.type = '02' Or b.type = '03')"
        If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & RST!kodebarang & "' and b.tglmut < '" & tanggalpo & "' and (b.type = '02' Or b.type = '03')"
        Set RST1 = OBJ1.Execute(SQL1)
        If Not RST1.EOF Then
            txtnil8 = RST1!qty
        Else
        ...
        Do While True
            ...
            If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & RST!kodebarang & "' and b.tglmut = '" & tanggal2 & "' and b.type = '01'"
            If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & RST!kodebarang & "' and b.tglmut = '" & tanggal2 & "' and b.type = '01'"
            Set RST1 = OBJ1.Execute(SQL1)
            If Not RST1.EOF Then
                txtnil7 = RST1!qty
            Else
            ...
            If cmbtype = "01" Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where a.kodebarang = '" & RST!kodebarang & "' and b.tglmut = '" & tanggal2 & "' and (b.type = '02' Or b.type = '03')"
            If (cmbtype = "02" Or cmbtype = "03") Then SQL1 = "select isnull(sum(a.qty),0)'qty' from am_mutlin a left join am_muthdr b on a.nomut=b.nomut and a.type=b.type where b.nomut <> '" & txtnobukti & "' and a.kodebarang = '" & RST!kodebarang & "' and b.tglmut = '" & tanggal2 & "' and (b.type = '02' Or b.type = '03')"
            Set RST1 = OBJ1.Execute(SQL1)
            If Not RST1.EOF Then
                txtnil8 = RST1!qty
            Else
...
balik2:
    ...
    OBJ.Open dsn
    SQL = "delete from am_muthdr where nomut = '" & txtnobukti & "' and type = '" & cmbtype & "'"
    Set RST = OBJ.Execute(SQL)

    SQL = "delete from am_mutlin where nomut = '" & txtnobukti & "' and type = '" & cmbtype & "'"
    Set RST = OBJ.Execute(SQL)
...
Private Sub cmdsearch1_Click()
    ...
    If v_fastsearching = True Then
        If v_fstgl1 > v_fstgl2 Then
            ...
            Exit Sub
        End If
        carisql1 = "select nomut, convert(char(11),tglmut)'tglmut' from am_muthdr where type = '" & cmbtype & "' and tglmut >= '" & batas1 & "' and tglmut <= '" & batas2 & "'"
    Else
        carisql1 = "select nomut, convert(char(11),tglmut)'tglmut' from am_muthdr where type = '" & cmbtype & "'"
    End If
    namatabel = "Mutasi"
...
Private Sub Form_Activate()
    ...
    'If kuser <> "q" Then
    '    OBJ.Open dsn
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='142' and b.kodeuser = '2" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
    '    If RST.EOF Then cmdadd.Enabled = False
        
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='143' and b.kodeuser = '2" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
...
Private Sub carinvoice()
    ...
    OBJ.Open dsn
    SQL = "select * from am_muthdr where nomut = '" & txtnobukti & "' and type = '" & cmbtype & "'"
    Set RST = OBJ.Execute(SQL)
    If Not RST.EOF Then
        date1 = RST!tglmut
        txtdriver = RST!keterangan
        
        grid.Row = 1
        SQL = "select * from am_mutlin where nomut = '" & txtnobukti & "' and type = '" & cmbtype & "' order by lineitem asc"
        Set RST = OBJ.Execute(SQL)
        Do Until RST.EOF
            grid.Col = 1
            grid.CellAlignment = 1
