...
Private Sub grid_Click()
    ...
    If grid.MouseRow > 0 Then
        ...
        ElseIf namatabel = "Barang per Divisi" Then
            hasil2 = grid.TextMatrix(grid.Row, 5)
        ElseIf namatabel = "Barang per Divisi " Or namatabel = "Barang per Divisi." Then
            hasil2 = grid.TextMatrix(grid.Row, 3)
            hasil3 = grid.TextMatrix(grid.Row, 2)
        Else
            hasil2 = ""
        End If
...
Private Sub txtsearch_Change()
    ...
    ElseIf namatabel = "Barang per Divisi " Or namatabel = "Barang per Divisi." Then
        If Label4 = "KodeBarang" Or Label4 = "NamaBarang" Then SQL = carisql1 + " and a." + Label4 + " like '" + txtsearch + "%' ORDER BY a." + Label4
        If Label4 = "NamaSatuan" Then SQL = carisql1 + " and b." + Label4 + " like '" + txtsearch + "%' ORDER BY b." + Label4
...
Private Sub setAlternatingrid()
    ...
    grid.Row = 1
    Do While True
        If grid.TextMatrix(grid.Row, 4) = "0" Then
