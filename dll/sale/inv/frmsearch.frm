...
Private Sub showtran()
    ...
    If RST.EOF Then
        ...
        namatabel = "Faktur Penjualan" Or _
...
Private Sub showtabel()
    ...
    ElseIf namatabel = "Customer" Then
        SQL = carisql1
    ElseIf namatabel = "Gudang" Then
        SQL = carisql1 + " where KodeGudang <> 'G3'"
    ElseIf namatabel = "Item on Lot" Then
        SQL = carisql1
    ElseIf namatabel = "Penjualan" Then
        SQL = carisql1 + " order by nobkt asc"
    ElseIf namatabel = "Lot Item" Then
        SQL = carisql1 + " group by a.nolot,a.kodebarang,b.namabarang,a.hppperkg,a.kg,c.total"
    Else
        SQL = carisql1
    End If
    Set RST = OBJ.Execute(SQL)
    ...
    ElseIf namatabel = "Lot Item" Then
        ...
        grid.ColWidth(4) = 0
        grid.ColWidth(5) = 0
    ElseIf namatabel = "Surat Jalan." Then
        grid.ColWidth(0) = 1500
        grid.ColWidth(1) = 2600
        grid.ColWidth(2) = 1600
        grid.ColWidth(3) = 0
    ElseIf namatabel = "SJ Item" Then
        grid.ColWidth(0) = 1500
        grid.ColWidth(1) = 2600
        grid.ColWidth(2) = 1600
...
Private Sub Form_Load()
    ...
    If namatabel = "Retur Penjualan" Or _
    namatabel = "Pembayaran" Or _
    ...
    namatabel = "Sales Order  " Then
        ...
        If namatabel = "Sales Order " Or _
        namatabel = "Faktur Penjualan" Then
            Me.Width = 6000
            grid.Width = 5655
    ...
    ElseIf namatabel = "Penjualan" Then
        Adodc1.ConnectionString = dsn
        Adodc1.RecordSource = carisql1 & " Order by nobkt asc"
        Set grid.DataSource = Adodc1
        grid.Refresh
        Me.Width = 4000
        grid.Width = 3655
        cmdcancel.Width = 3655
        txtsearch.Width = 3000
    ElseIf namatabel = "Item on Lot" Then
        Me.Width = 9600
        grid.Width = 9255
        cmdcancel.Width = 9255
...
Private Sub grid_Click()
    ...
    If grid.MouseRow > 0 Then
        ...
        If namatabel = "Lot Item" Then
            hasil = grid.TextMatrix(grid.Row, 0)
            hasil1 = grid.TextMatrix(grid.Row, 3)
            hasil2 = grid.TextMatrix(grid.Row, 4)
            hasil3 = grid.TextMatrix(grid.Row, 5)
        ElseIf namatabel = "Surat Jalan." Then
            hasil = grid.TextMatrix(grid.Row, 0)
            hasil1 = grid.TextMatrix(grid.Row, 1)
            hasil2 = grid.TextMatrix(grid.Row, 3)
        ElseIf namatabel = "SJ Item" Then
            hasil = grid.TextMatrix(grid.Row, 0)
            hasil1 = grid.TextMatrix(grid.Row, 1)
            ...
            hasil5 = grid.TextMatrix(grid.Row, 5)
            hasil6 = grid.TextMatrix(grid.Row, 6)
        End If
        Unload Me
        Exit Sub
    End If
...
Private Sub txtsearch_Change()
    ...
    ElseIf namatabel = "Faktur Penjualan" Then
        SQL = carisql1 + " and " + Label4 + " like '" + txtsearch + "%' order by nobkt asc"
    ElseIf namatabel = "Penjualan" Then
        SQL = carisql1 + " and " + Label4 + " like '" + txtsearch + "%' order by nobkt asc"
    ElseIf namatabel = "Item Lot" Then
        SQL = carisql1 + " and " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "Lot Item" Then
        SQL = carisql1 + " and " + Label4 + " like '" + txtsearch + "%' group by a.nolot,a.kodebarang,b.namabarang,a.hppperkg,a.kg,c.total"
    ElseIf namatabel = "SJ Item" Then
        If Label4 = "kodebarang" Then
