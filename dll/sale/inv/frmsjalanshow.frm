...
Begin VB.Form frmsjalanshow 
   ...
   End
End
Attribute VB_Name = "frmsjalanshow"
...
Private Sub cmdprint_Click()
    ...
    SQL = "update am_sjhdr set via2='1' where nosj = '" & setup1 & "'"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
