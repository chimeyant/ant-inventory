...
Begin VB.Form frmpindahwip 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mutasi ke WIP"
   ClientHeight    =   4905
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   9600
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilai 
      ...
      _ExtentX        =   3201
      _ExtentY        =   450
      Calculator      =   "frmpindahwip.frx":0630
      Caption         =   "frmpindahwip.frx":0650
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmpindahwip.frx":06BC
      Keys            =   "frmpindahwip.frx":06DA
      Spin            =   "frmpindahwip.frx":071C
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
   ...
   Begin TDBText6Ctl.TDBText txtket 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmpindahwip.frx":07B0
      Key             =   "frmpindahwip.frx":07CE
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin VB.Label lbltype 
      Caption         =   "16.  Keluar Ke Bahan Baku (Out)"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmpindahwip"
...
Private Sub cmdclear_Click()
    ...
    If Len(str99) = 1 Then txtnobukti = "KKB0-" & strformat & "000" & str99
    If Len(str99) = 2 Then txtnobukti = "KKB0-" & strformat & "00" & str99
    If Len(str99) = 3 Then txtnobukti = "KKB0-" & strformat & "0" & str99
    If Len(str99) = 4 Then txtnobukti = "KKb0-" & strformat & str99
End Sub
...
On Error Resume Next
    ...
    Select Case grid.Col
        ...
        Case 6
            ...
            'carisql1 = carisql1 + " Where kodebarang='" & grid.TextMatrix(grid.Row, 1) & "' and flag = '0'"
            namatabel = "Daftar Nomor Lot"
