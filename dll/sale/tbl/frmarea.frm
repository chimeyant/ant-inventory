...
Private Sub cmdadd_Click()
    ...
    OBJ.Open dsn
    SQL = "SELECT * FROM AM_area WHERE Kode = '" & txtunitcode & "'"
...
Private Sub Form_Activate()
    ...
    'If kuser <> "q" Then
    '    OBJ.Open dsn
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='51' and b.kodeuser = '1" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
    '    If RST.EOF Then
