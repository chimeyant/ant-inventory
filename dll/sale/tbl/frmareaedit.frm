...
Private Sub cmddel_Click()
    ...
    OBJ.Open dsn
    SQL = "select * from AM_customer WHERE Kodearea = '" & txtKode & "'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
        SQL = "DELETE AM_area WHERE Kode = '" & txtKode & "'"
        Set RST = OBJ.Execute(SQL)
        OBJ.Close
...
Private Sub cmdupdate_click()
    ...
    OBJ.Open dsn
    SQL = "UPDATE AM_area SET "
    SQL = SQL + "Nama = '" & txtdesc & "',"
...
Private Sub Form_Activate()
    ...
    'If kuser <> "q" Then
    '    OBJ.Open dsn
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='52' and b.kodeuser = '1" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
    '    If RST.EOF Then cmdupdate.Enabled = False
        
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='53' and b.kodeuser = '1" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
