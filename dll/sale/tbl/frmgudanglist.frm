...
Begin VB.Form frmgudanglist 
   ...
   End
End
Attribute VB_Name = "frmgudanglist"
...
Private Sub cmdpreview_Click()
    ...
    Crystal.DataFiles(0) = "Proc(am_listgudang)"
    Crystal.ReportFileName = AppPath & "\reports\sale\tbl\listgudang.rpt"
...
Private Sub Form_Activate()
    ...
    'If kuser <> "q" Then
    '    OBJ.Open dsn
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='45' and b.kodeuser = '1" & kuser & "'"
...
Private Sub cariunit1()
    ...
    OBJ.Open dsn
    SQL = "select * from am_gudang where kodegudang = '" & txtkode1 & "'"
    Set RST = OBJ.Execute(SQL)
    If Not RST.EOF Then
        OBJ.Close
        Exit Sub
