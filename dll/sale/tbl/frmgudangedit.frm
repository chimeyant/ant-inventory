...
Begin VB.Form frmgudangedit 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Change Gudang"
   ClientHeight    =   1635
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4215
   ...
   End
End
Attribute VB_Name = "frmgudangedit"
...
Private Sub cmddel_Click()
    ...
    OBJ.Open dsn
    SQL = "select * from AM_sjhdr WHERE Kodegudang = '" & txtKode & "'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
        SQL = "DELETE AM_gudang WHERE Kodegudang = '" & txtKode & "'"
        Set RST = OBJ.Execute(SQL)
        OBJ.Close
...
Private Sub cmdupdate_click()
    ...
    OBJ.Open dsn
    SQL = "UPDATE AM_gudang SET "
    SQL = SQL + "Namagudang = '" & txtdesc & "',"
    SQL = SQL + "idUpdate = '" & kuser & "',"
    SQL = SQL + "DateUpdate = convert(datetime,'" & tanggalsekarang & "')"
    SQL = SQL + "WHERE Kodegudang =  '" & txtKode & "'"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
...
Private Sub Form_Activate()
    ...
    'If kuser <> "q" Then
    '    OBJ.Open dsn
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='42' and b.kodeuser = '1" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
    '    If RST.EOF Then cmdupdate.Enabled = False
        
    '    SQL = "select a.* from am_level a left join am_user b on a.kode=b.kodelevel where a.program='43' and b.kodeuser = '1" & kuser & "'"
    '    Set RST = OBJ.Execute(SQL)
...
Private Sub cariunit()
    ...
    OBJ.Open dsn
    SQL = "select * from am_gudang where kodegudang = '" & txtKode & "'"
    Set RST = OBJ.Execute(SQL)
    If Not RST.EOF Then
