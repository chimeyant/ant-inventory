...
Begin VB.Form frmoutranposting 
   ...
   ControlBox      =   0   'False
   Icon            =   "frmoutranposting.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TDBText6Ctl.TDBText txtcom1 
      ...
      _ExtentX        =   1508
      _ExtentY        =   503
      Caption         =   "frmoutranposting.frx":2372
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmoutranposting.frx":23DE
      Key             =   "frmoutranposting.frx":23FC
   ...
   Begin TDBText6Ctl.TDBText txtkodetran1 
      ...
      _ExtentX        =   873
      _ExtentY        =   503
      Caption         =   "frmoutranposting.frx":2438
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmoutranposting.frx":24A4
      Key             =   "frmoutranposting.frx":24C2
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran1 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Caption         =   "frmoutranposting.frx":24FE
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmoutranposting.frx":256A
      Key             =   "frmoutranposting.frx":2588
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtkodetran2 
      ...
      _ExtentX        =   873
      _ExtentY        =   503
      Caption         =   "frmoutranposting.frx":25C4
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmoutranposting.frx":2630
      Key             =   "frmoutranposting.frx":264E
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran2 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Caption         =   "frmoutranposting.frx":268A
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmoutranposting.frx":26F6
      Key             =   "frmoutranposting.frx":2714
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin Chameleon.chameleonButton cmdsearch1 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmoutranposting.frx":2750
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsubmit 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmoutranposting.frx":2A6A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdclose 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmoutranposting.frx":2D84
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmoutranposting"
...
Private Sub CmdSubmit_Click()
    ...
    Set RST = OBJ.Execute(SQL)
    Do While Not RST.EOF
        If RST!tglawal > date1 Or RST!tglakhir < date2 Then
            MsgBox "Date Range Out Of Periode Date.", vbInformation, "Information"
            OBJ.Close
            Exit Sub
        End If
        RST.MoveNext
    ...
    OBJ.Open dsn
    SQL = "select a.*,b.* from gl_transaksi a left join gl_company b on a.kdcomp = b.kdcomp where a.kdcomp = '" & txtcom1 & "' and a.tgltrx >= '" & tanggal1 & "' and a.tgltrx <= '" & tanggal2 & "' and a.tgltrx >= b.tglawal and a.tgltrx <= b.tglakhir and a.kdtrx >= '" & str1 & "' and a.kdtrx <= '" & str2 & "' and a.notrx >= '" & str3 & "' and a.notrx <= '" & str4 & "' and a.flag = 'B' and a.flagprint = 'O'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
    ...
    SQL = SQL + "VALUES"
    SQL = SQL + "('" & compname & "'"
    SQL = SQL + ",'Posting Cash/Bank Out')"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
    
    SP.ActiveConnection = dsn
    SP.CommandType = adCmdStoredProc
    SP.CommandText = "gl_postingtran"
    vsp(0) = txtcom1
    ...
    OBJ.Open dsn
    SQL = "delete from toogle where comp_id = '" & compname & "' and task = 'Posting Cash/Bank Out'"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
...
Private Sub carikodetran1()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_transaksi where kdtrx = '" & txtkodetran1 & "' and flagprint = 'O'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
...
Private Sub carikodetran2()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_transaksi where kdtrx = '" & txtkodetran2 & "' and flagprint = 'O'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
