...
Begin VB.Form frmpengeluarangl 
   BackColor       =   &H00FFFFFF&
   ...
   Begin TDBNumber6Ctl.TDBNumber txtncash 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Calculator      =   "frmpengeluarangl.frx":0000
      Caption         =   "frmpengeluarangl.frx":0020
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmpengeluarangl.frx":008C
      Keys            =   "frmpengeluarangl.frx":00AA
      Spin            =   "frmpengeluarangl.frx":00EC
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
   ...
   End
End
Attribute VB_Name = "frmpengeluarangl"
