...
Begin VB.Form frmtranposting 
   ...
   Begin TDBText6Ctl.TDBText txtcom1 
      ...
      _ExtentX        =   1508
      _ExtentY        =   503
      Caption         =   "frmtranposting.frx":2372
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranposting.frx":23DE
      Key             =   "frmtranposting.frx":23FC
   ...
   Begin TDBText6Ctl.TDBText txtkodetran1 
      ...
      _ExtentX        =   873
      _ExtentY        =   503
      Caption         =   "frmtranposting.frx":2438
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranposting.frx":24A4
      Key             =   "frmtranposting.frx":24C2
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran1 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Caption         =   "frmtranposting.frx":24FE
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranposting.frx":256A
      Key             =   "frmtranposting.frx":2588
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtkodetran2 
      ...
      _ExtentX        =   873
      _ExtentY        =   503
      Caption         =   "frmtranposting.frx":25C4
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranposting.frx":2630
      Key             =   "frmtranposting.frx":264E
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran2 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Caption         =   "frmtranposting.frx":268A
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranposting.frx":26F6
      Key             =   "frmtranposting.frx":2714
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmtranposting"
...
Private Sub CmdSubmit_Click()
    ...
    OBJ.Open dsn
    SQL = "select a.*,b.* from gl_transaksi a left join gl_company b on a.kdcomp = b.kdcomp where a.kdcomp = '" & txtcom1 & "' and a.tgltrx >= '" & tanggal1 & "' and a.tgltrx <= '" & tanggal2 & "' and a.tgltrx >= b.tglawal and a.tgltrx <= b.tglakhir and a.kdtrx >= '" & str1 & "' and a.kdtrx <= '" & str2 & "' and a.notrx >= '" & str3 & "' and a.notrx <= '" & str4 & "' and a.flag = 'B' and a.flagprint = 'J'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
    ...
    OBJ.Open dsn
    SQL = "delete from toogle where comp_id = '" & compname & "' and task = 'Posting Journal'"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
...
Private Sub carikodetran1()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_transaksi where kdtrx = '" & txtkodetran1 & "' and flagprint = 'J'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
...
Private Sub carikodetran2()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_transaksi where kdtrx = '" & txtkodetran2 & "' and flagprint = 'J'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
