...
Begin VB.Form frmintran 
   ...
   Begin TDBText6Ctl.TDBText txtket 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":23DE
      Key             =   "frmintran.frx":23FC
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilai 
      ...
      _ExtentX        =   3201
      _ExtentY        =   450
      Calculator      =   "frmintran.frx":2438
      Caption         =   "frmintran.frx":2458
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":24C4
      Keys            =   "frmintran.frx":24E2
      Spin            =   "frmintran.frx":2524
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBText6Ctl.TDBText txtkodecomp 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":2BE8
      Key             =   "frmintran.frx":2C06
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtkodetran 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":2CAE
      Key             =   "frmintran.frx":2CCC
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtkodecur 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":2D74
      Key             =   "frmintran.frx":2D92
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBNumber6Ctl.TDBNumber txtnilaikurs 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Calculator      =   "frmintran.frx":2DCE
      Caption         =   "frmintran.frx":2DEE
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":2E5A
      Keys            =   "frmintran.frx":2E78
      Spin            =   "frmintran.frx":2EBA
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
   ...
   Begin TDBNumber6Ctl.TDBNumber txtkredit 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Calculator      =   "frmintran.frx":3830
      Caption         =   "frmintran.frx":3850
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":38BC
      Keys            =   "frmintran.frx":38DA
      Spin            =   "frmintran.frx":391C
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483628
   ...
   Begin TDBNumber6Ctl.TDBNumber txtdebet 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Calculator      =   "frmintran.frx":3944
      Caption         =   "frmintran.frx":3964
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":39D0
      Keys            =   "frmintran.frx":39EE
      Spin            =   "frmintran.frx":3A30
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483628
   ...
   Begin TDBText6Ctl.TDBText txtcash 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":40F8
      Key             =   "frmintran.frx":4116
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBNumber6Ctl.TDBNumber txtncash 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Calculator      =   "frmintran.frx":446C
      Caption         =   "frmintran.frx":448C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":44F8
      Keys            =   "frmintran.frx":4516
      Spin            =   "frmintran.frx":4558
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483628
   ...
   Begin TDBText6Ctl.TDBText txtketcash 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":45EC
      Key             =   "frmintran.frx":460A
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtcekbg 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":46B2
      Key             =   "frmintran.frx":46D0
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmintran.frx":4778
      Key             =   "frmintran.frx":4796
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
    ...
    If txtkodetran <> "BM" Then
        ...
        If Not RST.EOF Then
            If MsgBox("Can't Add, " & txtkodetran & txtnotran & " , Transaction Already Exist." & vbCrLf & "click OK to add with next number.", vbOKCancel + vbQuestion, "Information") = vbOK Then
                ...
                SQL = "select top 1 right(notrx,5)'notrx' from gl_transaksi where kdcomp = '" & txtkodecomp & "' and kdtrx = '" & txtkodetran & "' and notrx like '" & Format(date1, "YYMM") & "/" & cmbdaerah & "/%' and flagprint='I' order by notrx desc"
                Set RST = OBJ.Execute(SQL)
                If Not RST.EOF Then
...
Private Sub ViewReport()
    ...
    SQL = "Select a.tgltrx,a.notrx,a.noactrx,a.desctrx,a.amounttrx,a.cekbg,b.nmac "
    SQL = SQL + "From gl_transaksi as a inner join gl_masterac as b on b.noac=a.noactrx "
    SQL = SQL + "Where a.notrx = '" + txtnotran + "' and a.dbkrtrx = 'D' and a.kdtrx = 'KM'"
    ...
    If KeyAscii = 13 Then
        Select Case grid.Col
            Case 1
                ...
                OBJ.Open dsn
                'sql = "select * from gl_chacct where noac = '" & x_original(grid.TextMatrix(grid.Row, 1)) & "' and kdcomp = '" & txtkodecomp & "'"
                ...
                If Not RST.EOF Then
                    ...
                    grid.TextMatrix(posrow, 1) = original(RST!noac)
                    lblnamacc = "Nama Account : " & RST!nmac
                    OBJ.Close
                    grid.Col = 0
                    Set grid.CellPicture = uncheck.Picture
...
Private Sub txtnotran_KeyDown(KeyCode As Integer, Shift As Integer)
    If txtkodetran <> "BM" Then KeyCode = 0
End Sub

Private Sub txtnotran_KeyPress(KeyAscii As Integer)
    If txtkodetran <> "BM" Then KeyAscii = 0 Else KeyAscii = Asc(UCase(Chr(KeyAscii)))
    If KeyAscii = 13 And txtkodetran <> "BM" Then txtkodecur.SetFocus
End Sub
    ...
    If txtkodetran = "BM" Then
        If Len(txtnotran) = 8 Then
            ...
            If Not Right(txtnotran, 1) = "/" Then
                ...
                Exit Sub
            End If
            If Not (Mid(txtnotran, 6, 2) >= "01" And Mid(txtnotran, 6, 2) <= "09") And Not (Mid(txtnotran, 6, 2) >= "11" And Mid(txtnotran, 6, 2) <= "13") Then
            ...
            OBJ.Open dsn
            SQL = "select top 1 right(notrx,5)'notrx' from gl_transaksi where kdcomp = '" & txtkodecomp & "' and kdtrx = '" & txtkodetran & "' and notrx like '" & txtnotran & "%' and flagprint='I' order by notrx desc"
            Set RST = OBJ.Execute(SQL)
