...
Begin VB.Form frmtranunposting 
   ...
   ControlBox      =   0   'False
   Icon            =   "frmtranunposting.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin TDBText6Ctl.TDBText txtcom1 
      ...
      _ExtentX        =   1508
      _ExtentY        =   503
      Caption         =   "frmtranunposting.frx":2372
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranunposting.frx":23DE
      Key             =   "frmtranunposting.frx":23FC
   ...
   Begin TDBText6Ctl.TDBText txtkodetran1 
      ...
      _ExtentX        =   873
      _ExtentY        =   503
      Caption         =   "frmtranunposting.frx":2438
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranunposting.frx":24A4
      Key             =   "frmtranunposting.frx":24C2
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran1 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Caption         =   "frmtranunposting.frx":24FE
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranunposting.frx":256A
      Key             =   "frmtranunposting.frx":2588
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtkodetran2 
      ...
      _ExtentX        =   873
      _ExtentY        =   503
      Caption         =   "frmtranunposting.frx":25C4
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranunposting.frx":2630
      Key             =   "frmtranunposting.frx":264E
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin TDBText6Ctl.TDBText txtnotran2 
      ...
      _ExtentX        =   3201
      _ExtentY        =   503
      Caption         =   "frmtranunposting.frx":268A
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmtranunposting.frx":26F6
      Key             =   "frmtranunposting.frx":2714
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin Chameleon.chameleonButton cmdsubmit 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmtranunposting.frx":2750
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdclose 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmtranunposting.frx":2A6A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch1 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmtranunposting.frx":2D84
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmtranunposting"
...
Private Sub CmdSubmit_Click()
    ...
    Do While Not RST.EOF
        If RST!comp_id <> GetTheComputerName Then
            MsgBox "Mohon tunggu beberapa saat sedang ada posting data" & vbCrLf & _
    ...
    OBJ.Open dsn
    SQL = "select a.*,b.* from gl_transaksi a left join gl_company b on a.kdcomp = b.kdcomp where a.kdcomp = '" & txtcom1 & "' and a.tgltrx >= '" & tanggal1 & "' and a.tgltrx <= '" & tanggal2 & "' and a.tgltrx >= b.tglawal and a.tgltrx <= b.tglakhir and a.kdtrx >= '" & str1 & "' and a.kdtrx <= '" & str2 & "' and a.notrx >= '" & str3 & "' and a.notrx <= '" & str4 & "' and a.flag = 'P' and a.flagprint = 'J'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
    ...
    OBJ.Open dsn
    SQL = "delete from toogle where comp_id = '" & compname & "' and task = 'Unposting Journal'"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
