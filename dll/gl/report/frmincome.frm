...
Begin VB.Form frmincome 
   ...
   Begin VB.CheckBox Check1 
      Caption         =   "With Analyst (Percentage)"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.OptionButton Option4 
      Caption         =   "Comparative Current Month With Budget"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.OptionButton Option3 
      Caption         =   "Comparative Current Month With YTD Actual"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin TDBNumber6Ctl.TDBNumber txtpanjang 
      ...
      _ExtentX        =   3413
      _ExtentY        =   503
      Calculator      =   "frmincome.frx":2372
      Caption         =   "frmincome.frx":2392
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmincome.frx":23E7
      Keys            =   "frmincome.frx":2405
      Spin            =   "frmincome.frx":243F
      AlignHorizontal =   2
      AlignVertical   =   2
      Appearance      =   0
   ...
   Begin VB.OptionButton Option5 
      Caption         =   "Comparative YTD Actual With YTD Budget"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
Private Sub cariarea1()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_rforms where form_no = '" & txtarea1 & "' and report_type = '2'"
...
Private Sub cmdview_Click()
    ...
    ElseIf Option3.Value = True Then
        crystal.Connect = dsnreport
        crystal.ReportFileName = AppPath & "\reports\gl\report\inc_bal3.rpt"
        crystal.DataFiles(0) = "Proc(gl_inc_bal3)"
        crystal.ParameterFields(0) = "@form;" + txtarea1 + ";true"
        crystal.ParameterFields(1) = "@com1;" + txtcom1 + ";true"
        crystal.ParameterFields(2) = "@com2;" + txtcom2 + ";true"
        crystal.ParameterFields(3) = "@periode;" + period + ";true"
        ...
        crystal.ParameterFields(5) = "@namacomp;" + nmcomp + ";true"
        crystal.ParameterFields(6) = "@bulan;" + bulan + ";true"
        'crystal.ParameterFields(7) = "@bulan1;" + bulan1 + ";true"
    ElseIf Option4.Value = True Then
        crystal.Connect = dsnreport
        crystal.ReportFileName = AppPath & "\reports\gl\report\inc_bal4.rpt"
        ...
        crystal.ParameterFields(5) = "@namacomp;" + nmcomp + ";true"
        crystal.ParameterFields(6) = "@bulan;" + bulan + ";true"
        crystal.ParameterFields(7) = "@pilih;" + "income" + ";true"
    ElseIf Option5.Value = True Then
        crystal.Connect = dsnreport
        crystal.ReportFileName = AppPath & "\reports\gl\report\inc_bal5.rpt"
        crystal.DataFiles(0) = "Proc(gl_inc_bal5)"
        crystal.ParameterFields(0) = "@form;" + txtarea1 + ";true"
        crystal.ParameterFields(1) = "@com1;" + txtcom1 + ";true"
        crystal.ParameterFields(2) = "@com2;" + txtcom2 + ";true"
        crystal.ParameterFields(3) = "@periode;" + period + ";true"
...
Function bulan1()
    ...
    SQL = "select * from gl_company where kdcomp = '" & txtcom1 & "'"
    Set RST = OBJ.Execute(SQL)
    If RST!awalbulan = "12" Or RST!awalbulan = "13" Then
        bulan1 = "1"
    ElseIf RST!awalbulan = "1" Then
        bulan1 = "2"
    ElseIf RST!awalbulan = "2" Then
        bulan1 = "3"
    ElseIf RST!awalbulan = "3" Then
        bulan1 = "4"
    ElseIf RST!awalbulan = "4" Then
        bulan1 = "5"
    ElseIf RST!awalbulan = "5" Then
        bulan1 = "6"
    ElseIf RST!awalbulan = "6" Then
        bulan1 = "7"
    ElseIf RST!awalbulan = "7" Then
        bulan1 = "8"
    ElseIf RST!awalbulan = "8" Then
        bulan1 = "9"
    ElseIf RST!awalbulan = "9" Then
        bulan1 = "10"
    ElseIf RST!awalbulan = "10" Then
        bulan1 = "11"
    ElseIf RST!awalbulan = "11" Then
        bulan1 = "12"
    End If
    OBJ.Close
End Function
