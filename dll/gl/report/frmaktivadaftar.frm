...
Begin VB.Form frmaktivadaftar 
   ...
   Begin Chameleon.chameleonButton cmdview 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmaktivadaftar.frx":2372
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdclose 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmaktivadaftar.frx":268C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch1 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmaktivadaftar.frx":29A6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch2 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmaktivadaftar.frx":2CC0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch3 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmaktivadaftar.frx":2FDA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmaktivadaftar"
...
Private Sub cmdview_Click()
    ...
    crystal.ReportFileName = AppPath & "\reports\gl\report\aktivadaftar.rpt"
    crystal.DataFiles(0) = "Proc(gl_aktivadaftar)"
    ...
    crystal.ParameterFields(4) = "@no;" + total + ";true"
    crystal.ParameterFields(5) = "@now;" + Format(date1, "yyyyMMdd") + ";true"
...
Function total()
    str1 = 0
    OBJ.Open dsn
    SQL = "select * from gl_aktiva where kdcomp = '" & txtcom1 & "' and kdaktiva >= '" & txtkodefa1 & "' and kdaktiva <= '" & txtkodefa2 & "' and tgljual > '" & tanggal1 & "' and nilaijual > 0"
    Set RST = OBJ.Execute(SQL)
