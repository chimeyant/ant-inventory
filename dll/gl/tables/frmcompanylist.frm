...
Private Sub cmdview_Click()
    ...
    crystal.DataFiles(0) = "Proc(gl_companylist)"
    crystal.ReportFileName = AppPath & "\reports\gl\tables\companylist.rpt"
