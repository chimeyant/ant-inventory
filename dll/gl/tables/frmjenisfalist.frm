...
Begin VB.Form frmjenisfalist 
   ...
   End
End
Attribute VB_Name = "frmjenisfalist"
...
Private Sub cariarea1()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_jenis where kdjenis = '" & txtarea1 & "'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
        MsgBox "Jenis F/A " & txtarea1 & " Not Found.", vbExclamation, "Warning"
        txtarea1 = ""
        lblnamarea1 = ""
        txtarea1.SetFocus
    Else
        lblnamarea1 = RST!nmjenis
    End If
    OBJ.Close
End Sub
...
Private Sub cariarea2()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_jenis where kdjenis = '" & txtarea2 & "'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
        MsgBox "Jenis F/A " & txtarea2 & " Not Found.", vbExclamation, "Warning"
        txtarea2 = ""
        lblnamarea2 = ""
        txtarea2.SetFocus
    Else
        lblnamarea2 = RST!nmjenis
    End If
    OBJ.Close
End Sub
...
Private Sub cmdview_Click()
    ...
    crystal.DataFiles(0) = "Proc(gl_jenislist)"
    crystal.ReportFileName = AppPath & "\reports\gl\tables\jenislist.rpt"
