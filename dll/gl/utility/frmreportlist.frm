...
Private Sub cmdview_Click()
    ...
    crystal.ReportFileName = AppPath & "\reports\gl\utility\reportlist.rpt"
    crystal.DataFiles(0) = "Proc(gl_reportlist)"
