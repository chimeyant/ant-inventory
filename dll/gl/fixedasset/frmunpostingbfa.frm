...
Begin VB.Form frmunpostingbfa 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Unposting Pembelian Fixed Assets"
   ClientHeight    =   3945
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   7815
   ...
   Begin Chameleon.chameleonButton cmdsubmit 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmunpostingbfa.frx":2372
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdclose 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmunpostingbfa.frx":268C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch1 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmunpostingbfa.frx":29A6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch2 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmunpostingbfa.frx":2CC0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Chameleon.chameleonButton cmdsearch3 
      ...
      MCOL            =   12632256
      MPTR            =   99
      MICON           =   "frmunpostingbfa.frx":2FDA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmunpostingbfa"
...
Private Sub cmdsearch2_Click()
    ...
    namatabel = "Unposting Pembelian F/A"
...
Private Sub CmdSubmit_Click()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_aktiva where kdcomp = '" & txtcom1 & "' and kdaktiva >= '" & txtkodefa1 & "' and kdaktiva <= '" & txtkodefa2 & "' and tglbeli >= '" & tanggal1 & "' and tglbeli <= '" & tanggal2 & "' and flag = 'P'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
    ...
    SQL = SQL + ",'Unposting Pembelian Fixed Assets')"
    Set RST = OBJ.Execute(SQL)
    OBJ.Close
    ...
    Do While Not RST.EOF
        ...
        If Trim(RST!curr1) = "" Then
            OBJ1.Open dsn
            SQL1 = "select * from gl_transaksi where kdcomp = '" & txtcom1 & "' and (kdtrx = 'JS' or kdtrx = 'JB') and notrx = '" & str1 & "' and flag = 'P'"
            Set RST1 = OBJ1.Execute(SQL1)
            If RST1.EOF Then
                obj2.Open dsn
                sql2 = "delete from gl_transaksi where kdcomp = '" & txtcom1 & "' and (kdtrx = 'JS' or kdtrx = 'JB') and notrx = '" & str1 & "'"
                Set rst2 = obj2.Execute(sql2)
                
                sql2 = "update gl_aktiva set flag = 'N' where kdcomp = '" & txtcom1 & "' and kdaktiva = '" & str1 & "' and flag = 'P'"
                Set rst2 = obj2.Execute(sql2)
                obj2.Close
            Else
                MsgBox "Can't Unposting Aktiva " & str1 & ", jurnal already posted. click OK to continue.", vbInformation, "Information"
            End If
            OBJ1.Close
        Else
            MsgBox "Can't Unposting Aktiva " & str1 & ", aktiva already sold. click OK to continue.", vbInformation, "Information"
        End If
        RST.MoveNext
    Loop
    OBJ.Close
    ...
    OBJ.Open dsn
    SQL = "delete from toogle where comp_id = '" & Trim(GetTheComputerName) & "'"
    SQL = SQL & " and task= 'Unposting Pembelian Fixed Assets'"
    OBJ.Execute SQL
    OBJ.Close
...
Private Sub carifa1()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_aktiva where kdcomp = '" & txtcom1 & "' and kdaktiva = '" & txtkodefa1 & "' and flag = 'P'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
...
Private Sub carifa2()
    ...
    OBJ.Open dsn
    SQL = "select * from gl_aktiva where kdcomp = '" & txtcom1 & "' and kdaktiva = '" & txtkodefa2 & "' and flag = 'P'"
    Set RST = OBJ.Execute(SQL)
    If RST.EOF Then
