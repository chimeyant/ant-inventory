...
Begin VB.Form frmkonvlist 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "List Konversi"
   ClientHeight    =   465
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   2655
...
Private Sub cmdprint_Click()
    ...
    crystal.DataFiles(0) = "Proc(am_listkonversi)"
