...
Private Sub showtran()
    ...
    ElseIf namatabel = "nolot base" Then
        grid.ColWidth(0) = 1400
        grid.ColWidth(1) = 0
        grid.ColWidth(2) = 2000
    Else
...
Private Sub showtabel()
    ...
    ElseIf namatabel = "gudang" Then
        SQL = carisql1 + " Where kodegudang = 'G3' or kodegudang='G1'"
    ElseIf namatabel = "gudang2" Then
        SQL = carisql1 + " Where kodegudang <> 'G3'"
    ElseIf namatabel = "Barang Jadi" Then
        SQL = carisql1 + " group by a.kodebarang,c.namabarang"
    ElseIf namatabel = "Base" Then
        SQL = carisql1 + " group by a.kode_bahan ,b.NamaBarang"
    ElseIf namatabel = "WIP Jadi" Then
        SQL = carisql1 ' + " group by a.kode_bahan ,b.NamaBarang"
    ElseIf namatabel = "Base Bahan" Then
        SQL = carisql1 + " order by kodebarang asc"
    ElseIf namatabel = "LotWIP Jadi" Then
        SQL = carisql1 + " where b.flagprint <= '4' and a.kode_bahan like 'L98%' or a.kode_bahan like 'K98%'"
    Else
        SQL = carisql1
    End If
    Set RST = OBJ.Execute(SQL)
...
Private Sub txtsearch_Change()
    ...
    ElseIf namatabel = "nolot" Then
        ...
        End If
    'ElseIf namatabel = "nolot" Then
        'SQL = carisql1 + " Where flagprint = '4' or flagprint = '3' and " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "gudang" Then
        SQL = carisql1 + " Where kodegudang = 'G3' and " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "gudang2" Then
        SQL = carisql1 + " Where kodegudang <> 'G3' and " + Label4 + " like '" + txtsearch + "%'"
    ElseIf namatabel = "Barang Jadi" Then
        If Label4 = "namabarang" Then
            SQL = carisql1 + " and c." + Label4 + " like '" + txtsearch + "%' group by a.kodebarang,c.namabarang"
        Else
            SQL = carisql1 + " and a." + Label4 + " like '" + txtsearch + "%' group by a.kodebarang,c.namabarang"
        End If
    ElseIf namatabel = "Base" Then
        If Label4 = "NamaBarang" Then
            SQL = carisql1 + " and b." + Label4 + " like '" + txtsearch + "%' group by a.kode_bahan ,b.NamaBarang"
        Else
            SQL = carisql1 + " and a." + Label4 + " like '" + txtsearch + "%' group by a.kode_bahan ,b.NamaBarang"
        End If
    ElseIf namatabel = "WIP Jadi" Then
        If Label4 = "NamaBarang" Then
            SQL = carisql1 + " and b." + Label4 + " like '" + txtsearch + "%'" ' group by a.kode_bahan ,b.NamaBarang"
    ...
    ElseIf namatabel = "LotWIP Jadi" Then
        SQL = carisql1 + " where b.flagprint <= '4' and (a.kode_bahan like 'L98%' or a.kode_bahan like 'K98%') and a." + Label4 + " like '" + txtsearch + "%'"
    Else
